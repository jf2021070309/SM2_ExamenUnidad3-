...
class RegistroExpositorView extends StatefulWidget {
  const RegistroExpositorView({super.key});

  @override
  State<RegistroExpositorView> createState() => _RegistroExpositorViewState();
}

class _RegistroExpositorViewState extends State<RegistroExpositorView> {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (mounted && authViewModel.state == AuthState.success) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Expositor registrado exitosamente'),
